...
$settings['hash_salt'] = 'ZGVmYXVsdAAAAAEAAAAAAKAGVqjAQgSo+G4AqA==';
...
// $settings['system.file.default_scheme'] = 's3';
$config['s3fs.settings']['region'] = getenv('S3_REGION');
$config['s3fs.settings']['bucket'] = getenv('S3_BUCKET');

// Disable config split by default on all environments.
...
switch ($appEnv) {
  case 'production':
    ...
    $config['environment_indicator.indicator']['bg_color'] = '#B70118';
